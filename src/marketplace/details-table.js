            ...
            <div>
                ...
                <div className="px-6">
                    <ul className="mt-2 mb-10 divide-y">
                        ...
                        <span className="flex-1 text-sm text-gray-500">200 @ <img className="h-4 inline-flex px-1" src={avax_icon} alt="AVAX" />5/share</span>
                        </li>
                        <li className="flex space-x-3 py-3">
                        <svg width="20" height="20" viewBox="0 0 20 20" fill="none" xmlns="http://www.w3.org/2000/svg">
                        ...
                        <span className="flex-1 text-sm text-gray-500">10,000 @ <img className="h-4 inline-flex px-1" src={avax_icon} alt="AVAX" />5/share</span>
                        </li>
                        <li className="flex space-x-3 py-3">
                        <svg width="20" height="20" viewBox="0 0 20 20" fill="none" xmlns="http://www.w3.org/2000/svg">
                        ...
                        <span className="flex-1 text-sm text-gray-500"><img className="h-4 inline-flex px-1" src={avax_icon} alt="AVAX" />7.30/share</span>
                        </li>
                        <li className="flex space-x-3 py-3">
                        <svg width="20" height="20" viewBox="0 0 20 20" fill="none" xmlns="http://www.w3.org/2000/svg">
                        ...
                        <span className="flex-1 text-sm text-gray-500"><img className="h-4 inline-flex px-1" src={avax_icon} alt="AVAX" />4.23 - <img className="h-4 inline-flex px-1" src={avax_icon} alt="AVAX" />7.98</span>
                        </li>
                        <li className="flex space-x-3 pt-3">
                        <svg width="20" height="20" viewBox="0 0 20 20" fill="none" xmlns="http://www.w3.org/2000/svg">
