    ...
    return (
        ...
        <div className="max-w-7xl mx-auto py-10 px-4 sm:px-6 lg:px-8">
            ...
            <div>
                ...
                <div className="px-3">
                    <ul className="mt-2 mb-10 space-y-10">
            ...
            <div>
                ...
                <div className="px-6">
                    <ul className="mt-2 mb-10 space-y-10">
                        ...
                        <span className="flex-1 text-sm text-gray-500">200 @ $5/share</span>
                        </li>
                        <li className="flex space-x-3">
                        <svg width="20" height="20" viewBox="0 0 20 20" fill="none" xmlns="http://www.w3.org/2000/svg">
                        ...
                        <span className="flex-1 text-sm text-gray-500">10,000 @ $5/share</span>
                        </li>
                        <li className="flex space-x-3">
                        <svg width="20" height="20" viewBox="0 0 20 20" fill="none" xmlns="http://www.w3.org/2000/svg">
                        ...
                        <span className="flex-1 text-sm text-gray-500">$4.23 - $7.98</span>
                        </li>
                        <li className="flex space-x-3">
                        <svg width="20" height="20" viewBox="0 0 20 20" fill="none" xmlns="http://www.w3.org/2000/svg">
