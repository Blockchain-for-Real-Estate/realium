                ...
                <div className="flex flex-1 items-center justify-center mt-12">
                    <div className="max-w-lg w-full lg:max-w-xs">
                        ...
                        <div className="relative">
                            ...
                            <Field id="term" name="term" className="block w-full pl-10 pr-3 py-2 border border-gray-300 rounded-md leading-5 bg-white placeholder-gray-500 focus:outline-none focus:placeholder-gray-400 focus:ring-1 focus:ring-indigo-500 focus:border-indigo-500 sm:text-sm" placeholder="Search" type="search" />
                        </div>
                    </div>
                </div>
            </Form>
