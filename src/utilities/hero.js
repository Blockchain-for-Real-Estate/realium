...
>>>>>>> af92f5d (refactor hero as individual component, tailwind marketplace, static nav bar in listing detail, add persona to listings)
...
=======
            ...
            <div className="lg:absolute lg:inset-y-0 lg:right-0 lg:w-1/2">
                <img className="h-56 w-full object-cover sm:h-72 md:h-96 lg:w-full lg:h-full" src={props.image} alt=""/>
            </div>
            </div>
        </>
>>>>>>> af92f5d (refactor hero as individual component, tailwind marketplace, static nav bar in listing detail, add persona to listings)
