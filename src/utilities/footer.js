    ...
    return (
        ...
        <div className="max-w-7xl mx-auto py-12 px-4 sm:px-6 lg:py-10 lg:px-6">
            ...
            <div className="space-y-5 xl:col-span-1">
                <Link to="/">
                <svg width="204" height="99" viewBox="0 0 274 99" fill="none" xmlns="http://www.w3.org/2000/svg">
            ...
            <div className="mt-12 grid grid-cols-2 gap-8 xl:mt-10 xl:col-span-2">
                ...
                <div className="mt-12 md:mt-0">
                    ...
                    <ul className="mt-4 space-y-4">
                    <li>
                        <a href="https://docs.realium.io/introduction/background/blockchain-explained" target="_blank" rel="noreferrer" className="text-base text-gray-500 hover:text-gray-900">
                            Blockchain
                        </a>
                    </li>
                    <li>
                    <a href="https://docs.realium.io/introduction/background/avalanche-explained" target="_blank" rel="noreferrer" className="text-base text-gray-500 hover:text-gray-900">
                            Avalanche
                        </a>
                    </li>
                    <li>
                    <a href="https://docs.realium.io/introduction/background/tokenization-explained" target="_blank" rel="noreferrer" className="text-base text-gray-500 hover:text-gray-900">
                            Tokenization
                        </a>
                    </li>
                    </ul>
