        ...
        <div className="max-w-7xl mx-auto py-12 px-4 sm:px-6 lg:py-16 lg:px-8">
            ...
            <div className="mt-12 grid grid-cols-2 gap-8 xl:mt-0 xl:col-span-2">
                ...
                <div>
                    ...
                    <li>
                        <Link className="text-base text-gray-500 hover:text-gray-900" to="/marketplace">
                            Marketplace
                        </Link>
                    </li>
                    <li>
                ...
                <div className="mt-12 md:mt-0">
                    ...
                    <ul className="mt-4 space-y-4">
                    <li>
                        <a href="https://docs.realium.io/" className="text-base text-gray-500 hover:text-gray-900">
                            White Papers
                        </a>
                    </li>
                    <li>
